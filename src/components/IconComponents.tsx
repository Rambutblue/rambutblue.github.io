...
// Centralized file for all SVG icons, defined as functional components.
...
export const EyeIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639l4.443-4.443a1.012 1.012 0 011.43 0l4.443 4.443a1.012 1.012 0 010 .639l-4.443 4.443a1.012 1.012 0 01-1.43 0l-4.443-4.443z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.232 12.322a1.012 1.012 0 010-.639l4.443-4.443a1.012 1.012 0 011.43 0l4.443 4.443a1.012 1.012 0 010 .639l-4.443 4.443a1.012 1.012 0 01-1.43 0l-4.443-4.443z" />
    </svg>
);
